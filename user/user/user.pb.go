...
var file_user_proto_rawDesc = []byte{
	...
	0x0c, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x32, 0xbe, 0x0c,
...
var file_user_proto_depIdxs = []int32{
	...
	2,  // 2: user.User.CheckTwitterId:input_type -> user.CheckTwitterIdRequest
	4,  // 3: user.User.CreateUser:input_type -> user.CreateUserRequest
	6,  // 4: user.User.CreateInvite:input_type -> user.CreateInviteRequest
	8,  // 5: user.User.CheckTodayInvite:input_type -> user.CheckTodayInviteRequest
	10, // 6: user.User.AddUserInfo:input_type -> user.AddUserInfoRequest
	12, // 7: user.User.QueryUser:input_type -> user.QueryUserRequest
	20, // 8: user.User.AddAdmin:input_type -> user.AddAdminRequest
	22, // 9: user.User.AdminLogin:input_type -> user.AdminLoginRequest
	24, // 10: user.User.RemoveAdmin:input_type -> user.RemoveAdminRequest
	14, // 11: user.User.AddBlackList:input_type -> user.AddBlackListRequest
	16, // 12: user.User.QueryBlackList:input_type -> user.QueryBlackListRequest
	18, // 13: user.User.RemoveBlackList:input_type -> user.RemoveBlackListRequest
	26, // 14: user.User.GetHelpCategories:input_type -> user.GetHelpCategoriesRequest
	29, // 15: user.User.CreateHelpCategory:input_type -> user.CreateHelpCategoryRequest
	31, // 16: user.User.DeleteHelpCategory:input_type -> user.DeleteHelpCategoryRequest
	33, // 17: user.User.EditHelpCategory:input_type -> user.EditHelpCategoryRequest
	35, // 18: user.User.CreateHelpCategoryTranslation:input_type -> user.CreateHelpCategoryTranslationRequest
	37, // 19: user.User.DeleteHelpCategoryTranslation:input_type -> user.DeleteHelpCategoryTranslationRequest
	39, // 20: user.User.GetHelpCategoryTranslations:input_type -> user.GetHelpCategoryTranslationsRequest
	1,  // 21: user.User.Ping:output_type -> user.Response
	3,  // 22: user.User.CheckTwitterId:output_type -> user.CheckTwitterIdResponse
	5,  // 23: user.User.CreateUser:output_type -> user.CreateUserResponse
	7,  // 24: user.User.CreateInvite:output_type -> user.CreateInviteResponse
	9,  // 25: user.User.CheckTodayInvite:output_type -> user.CheckTodayInviteResponse
	11, // 26: user.User.AddUserInfo:output_type -> user.AddUserInfoResponse
	13, // 27: user.User.QueryUser:output_type -> user.QueryUserResponse
	21, // 28: user.User.AddAdmin:output_type -> user.AddAdminResponse
	23, // 29: user.User.AdminLogin:output_type -> user.AdminLoginResponse
	25, // 30: user.User.RemoveAdmin:output_type -> user.RemoveAdminResponse
	15, // 31: user.User.AddBlackList:output_type -> user.AddBlackListResponse
	17, // 32: user.User.QueryBlackList:output_type -> user.QueryBlackListResponse
	19, // 33: user.User.RemoveBlackList:output_type -> user.RemoveBlackListResponse
	28, // 34: user.User.GetHelpCategories:output_type -> user.GetHelpCategoriesResponse
	30, // 35: user.User.CreateHelpCategory:output_type -> user.CreateHelpCategoryResponse
	32, // 36: user.User.DeleteHelpCategory:output_type -> user.DeleteHelpCategoryResponse
	34, // 37: user.User.EditHelpCategory:output_type -> user.EditHelpCategoryResponse
	36, // 38: user.User.CreateHelpCategoryTranslation:output_type -> user.CreateHelpCategoryTranslationResponse
	38, // 39: user.User.DeleteHelpCategoryTranslation:output_type -> user.DeleteHelpCategoryTranslationResponse
	40, // 40: user.User.GetHelpCategoryTranslations:output_type -> user.GetHelpCategoryTranslationsResponse
